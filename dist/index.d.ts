...
declare const contextCache: <H extends HookContext<_feathersjs_feathers.Application<any, any>, any> = HookContext<_feathersjs_feathers.Application<any, any>, any>>(cacheMap: ContextCacheMap) => (context: any) => any;
...
declare const joinQuery: <H extends HookContext<_feathersjs_feathers.Application<any, any>, any>>(_options: JoinQueryOptions) => (context: any) => any;
...
declare const preventChange: (virtuals: any, prepFunc?: () => void) => (context: any) => any;

type RateLimitOptions = {
    makeKey?: (context: any) => string;
    makePoints?: (context: any) => number;
};
declare const rateLimit: (rateLimiter: RateLimiterMemory, _options?: RateLimitOptions) => (context: any) => any;

type SanitizeErrorOptions = SanitizeSchema | ((context: any) => SanitizeSchema);
declare const sanitizeError: (options: SanitizeErrorOptions) => (context: any) => any;

type SanitizeResultOptions = SanitizeSchema | ((context: any) => SanitizeSchema);
declare const sanitizeResult: (options: SanitizeResultOptions) => (context: any) => any;
 ...
 */
declare const withData: (virtuals: Virtuals, prepFunc?: PrepFunction) => (context: any) => any;

declare const withQuery: (virtuals: Virtuals, prepFunc?: PrepFunction) => (context: any) => any;

declare const withResult: (virtuals: Virtuals, prepFunc?: PrepFunction) => (context: any) => any;

declare const withoutData: (virtuals: Virtuals, prepFunc?: PrepFunction) => (context: any) => any;

declare const withoutQuery: (virtuals: Virtuals, prepFunc?: PrepFunction) => (context: any) => any;

declare const withoutResult: (virtuals: Virtuals, prepFunc?: PrepFunction) => (context: any) => any;
