import type * as _feathersjs_feathers from '@feathersjs/feathers';
import type { HookContext, Application } from '@feathersjs/feathers';
import type { LRUCache } from 'lru-cache';
import type { RateLimiterMemory } from 'rate-limiter-flexible';

type Promisable<T> = T | Promise<T>;
type SetPartial<T, K extends keyof T = keyof T> = Partial<Pick<T, K>> &
    Omit<T, K>;
...
declare const contextCache: <
    H extends HookContext<
        _feathersjs_feathers.Application<any, any>,
        any
    > = HookContext<_feathersjs_feathers.Application<any, any>, any>
>(
...
declare const joinQuery: <
    H extends HookContext<_feathersjs_feathers.Application<any, any>, any>
>(
...
declare const sanitizeError: (
    options: SanitizeErrorOptions
) => (context: any) => any;

type SanitizeResultOptions =
    | SanitizeSchema
    | ((context: any) => SanitizeSchema);
declare const sanitizeResult: (
...
declare const sequelizeJoinQuery: (
    options?: SequelizeJoinQueryOptions
) => (context: any) => any;
 ...
 */
declare const withData: (
    virtuals: Virtuals,
    prepFunc?: PrepFunction
) => (context: any) => any;

declare const withQuery: (
    virtuals: Virtuals,
    prepFunc?: PrepFunction
) => (context: any) => any;

declare const withResult: (
    virtuals: Virtuals,
    prepFunc?: PrepFunction
) => (context: any) => any;

declare const withoutData: (
    virtuals: Virtuals,
    prepFunc?: PrepFunction
) => (context: any) => any;

declare const withoutQuery: (
    virtuals: Virtuals,
    prepFunc?: PrepFunction
) => (context: any) => any;

declare const withoutResult: (
    virtuals: Virtuals,
    prepFunc?: PrepFunction
) => (context: any) => any;
...
declare const strictRestQuery: (
    opts?: StrictRestQueryOptions
) => (app: Application) => Application<any, any>;
...
export {
    ...
    SanitizeResultOptions,
    SequelizeJoinQueryOptions,
    StashableOptions,
    StrictRestQueryOptions,
    contextCache,
    joinQuery,
    jsonQueryClient,
    jsonQueryParse,
